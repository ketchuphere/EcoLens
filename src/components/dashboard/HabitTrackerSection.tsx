...
import { Flame, CheckCircle, RefreshCw, Trophy } from 'lucide-react';
...
export const HabitTrackerSection: React.FC<HabitTrackerSectionProps> = ({
  ...
  const handleCheckboxChanged = (key: keyof Omit<DailyHabits, 'date'>, _pts: number) => {
    onToggleHabit(key);
    ...
    <div className="space-y-6" id="habit_tracker_section_container">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 font-sans">
        ...
        <div className="lg:col-span-7 bg-white border border-slate-200/70 rounded-[32px] p-8 shadow-xs space-y-6">
          <div className="pb-4 border-b border-slate-100 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium font-sans">Earn daily environmental points by checking off micro-actions today</p>
            </div>
            <div className="flex items-center gap-1.5 bg-amber-50 text-amber-700 border border-amber-200 py-1.5 px-3 rounded-full font-bold text-xs select-none">
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-1 pr-12">
                    ...
                    <p className="text-[11px] text-slate-450 font-medium leading-normal pl-0.5">
                      {item.description}
                    </p>
                  </div>
          ...
          <div className="bg-slate-50 p-4 rounded-2xl text-slate-500 text-xs flex gap-2.5 border border-slate-200/60 leading-relaxed font-sans mt-3">
        ...
        <div className="lg:col-span-5 bg-white border border-slate-200/70 rounded-[32px] p-8 shadow-xs flex flex-col justify-between">
          <div className="pb-4 border-b border-slate-100 flex items-center justify-between font-sans">
            <div>
          ...
          <div className="grid grid-cols-2 gap-4 my-6 font-sans">
            {allBadges.map(badge => {
              ...
              return (
                ...
                >
                  ...
                  {isEarned ? (
                    ...
                    <span className="text-[8px] bg-slate-100 border border-slate-200 text-slate-500 font-semibold px-1.5 py-0.5 rounded-full uppercase scale-90">
                      Locked
                    </span>
                  )}
                </div>
          ...
          <div className="border-t border-slate-100 pt-4 flex gap-3 text-xs justify-between font-bold font-sans">
